...
| 4 | After Watchtower pulls the **2026-09-09** junk image, run `owner:reject-pending-junk-reviews` | Live image still predates pharmacy/seltzer/paper skip | Until that pull, heal **rejected=0**. After pull, expect a large drop; leftover steaks/salads/Eggo/ziti still need `/owner` Yes. Missing Aldi/Lidl/Food Lion A–P were not in the pasted slice |
