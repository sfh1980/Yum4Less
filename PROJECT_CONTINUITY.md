...
- **Settings picker omit (2026-09-03):** Settings, Owner Check, and density counts use one SSOT: recognized supermarket/club/dollar banners plus Target/Whole Foods. Convenience, bakeries, specialty (Capt Gregs), and independent OSM grocery leftovers stay map-only. Live yum4less.com still has the leak until Watchtower pulls this image. Do **not** claim more dinners.
...
**Limits:** Live pending rows stay until persist ingest or `owner:reject-pending-junk-reviews` on the new ingest image. Ninja oven / Estee Lauder / serum / perfume already matched in repo; they were leftover queue.
...
**Limits:** Live yum4less.com still lists the leak until this app image is published and Watchtower pulls. Density class may drop a notch where independents were inflating the 8-mile grocery count. Do not claim more dinners.
