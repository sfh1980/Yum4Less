...
| `npm test` (onboarding wizard on master) | 2026-08-24 | **1124/1124** pass (199 files) |
| `npm run build` (FAQ/Terms + wizard routes) | 2026-08-24 | **Pass** (Next.js 15.5.21) |
| `npm run test:integration` | 2026-08-24 | **50/50** pass |
| `npm run test:e2e:ci` (wizard on isolated :3100) | 2026-08-24 | **32 passed** / **2 skipped** |
