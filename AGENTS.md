...
> **Also:** [`README.md`](README.md) · [`PROJECT_CONTINUITY.md`](PROJECT_CONTINUITY.md) · [`.private/owner-decisions.md`](.private/owner-decisions.md) (owner-only distilled decisions)
...
| `@web-frontend-standards` | UI, map, forms, carousel, trust modals, accessibility, coordinate-first flows |
...
| UI trust copy, search flow, map, carousel, modals | Playwright MCP after `npm run dev` (coordinates **`37.6085`, `-77.3739`** primary; ZIP **`23111`** fallback-path only; fixture data) |
...
| **playwright** | Trust-sensitive UI Vitest cannot prove (map, trust labels, coordinate-first flow) | `npm run dev`; fixture/seed data; see testing rule for coordinates |
